...
const FlatList = ({ logo, type, subTitle, title, votes, edit = false, updateTotalVotes }: FlatListProps) => {
  ...
  const selectedInputStyle: string | null = vote > 0 ? 'border-2 border-violet-brand !text-black' : null;
