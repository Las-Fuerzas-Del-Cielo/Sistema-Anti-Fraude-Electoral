...
const Button: React.FC<ButtonProps> = ({
  ...
  const inactiveClasses =
    'bg-gray-inactive text-text-off border-gray-inactive cursor-not-allowed text-lg';
  const warningClass =
    'bg-white text-red hover-bg-gray-light hover-border-red border-red text-lg';
